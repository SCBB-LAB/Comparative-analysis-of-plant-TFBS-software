...
class datasetPrep(converter_template):
    ...
    def convert(self, samples_coord, len_seq, dir_data, block_core):
        ...
        reference_dir = "%s/genomes/tair10/" %(dir_data)
        genome_limit_path = "%s/genomes/tair10/tair10.fa.fai" %(dir_data) 
...
def main():
    ...
    chromID_validation = "chr4" #for A. thaliana
    chromID_test = "chr5" #for A. thaliana
