...
```
conda create -n dnabert python=3 # available version of python
...
#### 2.2 Model Training Based on Transformer
- **Input and output data repositories**

Make sure all directories are present to store your input data and output results before model training
- **Training** 
...
#### 3.2 Model Training Based on Transformer
- **Input and output data repositories**
