...
#f3=[i.split() for i in os.popen("python3.8 pwm.py motifs/ABI5_pos.fa "+file1+".csv temp").readlines()][0][0]
#f3=[i.split() for i in os.popen("python3.8 pwm.py motifs/GATA11_pos.fa "+file1+".csv temp").readlines()][0][0]
#f3=[i.split() for i in os.popen("python3.8 pwm.py motifs/MYB11_pos.fa "+file1+".csv temp").readlines()][0][0]
#f3=[i.split() for i in os.popen("python3.8 pwm.py motifs/WRKY45_pos.fa "+file1+".csv temp").readlines()][0][0]
#f3=[i.split() for i in os.popen("python3.8 pwm.py motifs/WRKY75_pos.fa "+file1+".csv temp").readlines()][0][0]
f3=[i.split() for i in os.popen("python3.8 pwm.py "+sys.argv[2]+" "+file1+".csv temp").readlines()][0][0]


f6 = open(sys.argv[3]+"_coverage_seq.txt", 'a')
